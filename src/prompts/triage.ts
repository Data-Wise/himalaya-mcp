      ...
      messages: [
        {
          ...
          content: {
            type: "text" as const,
            text: [
              `Triage my ${n} most recent emails with structured classification. For each email:`,
              "",
              "1. Use list_emails (page_size: " + n + ") to get recent emails",
              "2. Use read_email on each to understand the content",
              "3. Classify each with these dimensions:",
              "   - **Class:** Actionable | FYI | Skip",
              "   - **Priority:** High | Medium | Low",
              "   - **Category:** Meeting | Task | Newsletter | Notification | Receipt | Travel | Social | Other",
              "",
              ...
              "| ID | From | Subject | Class | Priority | Category | Suggested Action |",
              "|---|---|---|---|---|---|---|",
              "",
