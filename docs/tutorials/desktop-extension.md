...
After installing or updating the extension, restart Claude Desktop. The extension registers 26 tools, 6 prompts, and 3 resources.
...
- [MCP Tools Reference](../reference/commands.md) -- all 26 tools with parameters and examples
